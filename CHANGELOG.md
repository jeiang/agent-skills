...
- Copilot custom agents: exactly `reviewer` and `researcher`, pinned to GPT-6 Luna, unable to nest subagents, rendered from the same bodies as the Claude and Codex reviewer and researcher.
