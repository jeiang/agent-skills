...
2. Spawn the `task_orchestrator` custom agent with that invocation baseline. The coordinator owns repository inspection, prompt validation through `grill-with-docs`, clarification, task sizing, planning, implementation, changelog maintenance, bounded review, Git state, and publication approval.
