...
- `skill-doctor`, vendored from [warpdotdev/common-skills](https://github.com/warpdotdev/common-skills/tree/f589e224907eda566c13755529f59db563090d14/.agents/skills/skill-doctor), for grading installed skills by scoring recent local Warp, Claude Code, and Codex conversations against efficiency and code-quality rubrics, then drafting the skill edits the evidence justifies. It reads conversation history locally and never uploads transcripts.
